 ...
 * @typedef {(nodeName: string|!Function, attributes?: preact.PreactProps, ...args: preact.AcceptedChild|Array<preact.AcceptedChild>) => !preact.VNode} preact.h The pragma (rendering) function.
 * @typedef {preact.createElement} createElement The pragma (rendering) function. Alias of `h`.
 * @typedef {(nodeName: string|!Function, attributes?: preact.PreactProps, ...args: preact.AcceptedChild|Array<preact.AcceptedChild>) => !preact.VNode} preact.createElement The pragma (rendering) function. Alias of `h`.
 ...
 * @typedef {(vnode: !preact.VNode, props?: preact.PreactProps, ...args: preact.AcceptedChild|Array<preact.AcceptedChild>) => !preact.VNode} preact.cloneElement Clones the given VNode, optionally adding attributes/props and replacing its children.
